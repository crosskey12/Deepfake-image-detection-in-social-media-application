...
const CommentForm = ({ user, id, replyAt, getComments }) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className='w-full border-b border-[#66666645]'>
            ...
            {errMsg?.message && (<span role='alert' className={`text-sm ${errMsg?.status == "failed" ? "text-[#f64949fe" :
    ...
    return <div className='mb-2 bg-primary p-4 rounded-xl'>
            ...
            <p className='text-ascent-2'>
                {showAll === post?._id ? post?.description : post?.description.slice(0, 300)}
                {
                    post?.description?.length > 301 && (
                        showAll === post?._id ? <span className='text-blue ml-2 font-mediu cursor-pointer'
        ...
        <div className='mt-4 flex justify-between items-center px-3 py-2 text-ascent-2 text-base border-t border-[#66666645]'>
            ...
            <p className='flex gap-2 items-center text-base cursor-pointer' onClick={() => {
                setShowComments(showComments === post?._id ? 0 : post?._id);
...
<p className='flex gap-2 items-center text-base cursor-pointer'>
            ...
            <span className='text-blue curse-pointer' onClick={() => setReplyComments(comment?._id)}>Reply</span>
    </div>
    <div>
