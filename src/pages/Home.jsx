...
import { CustomButton, EditProfile, Loading, TextInput, TopBar } from '../components';
...
const Home = () => {
  ...
  <div className='home w-full px-0 lg:px-10 pb-20 2xl:px-40 bg-bgColor lg:rounded-lg h-screen overflow-hidden'>
      ...
      <div className='w-full flex gap-2 lg:gap-4 pt-5 pb-10 h-full'>
        ...
        <div className='flex-1 h-full px-4 flex flex-col gap-6 overflow-y-auto'>
          ...
          className='bg-primary px-4 rounded-lg'>
            ...
            {errMsg?.message && (
             ...
             <div className='flex items-center justify-between py-4'> {/* justify-between if video and gif is to be added */}
              <label
                 htmlFor='imgUpload'
        ...
        <div className='w-full bg-primary shadow-ssm rounded-lg px-6 py-5'>
